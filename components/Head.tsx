...
export const Head: FC<Props> = ({
  ogImage = 'https://lux.market/og-image.png',
  title = 'Lux Market | Multi-Chain NFT Explorer',
  description = 'Lux Market Multi-Chain NFT Explorer is an open source NFT explorer built on Lux Network.',
}) => {
  return (
    <NextHead>
      ...
      <meta property="og:image:alt" content="Lux Market NFT Explorer Banner" />
    </NextHead>
  )
}
